import { n as __require } from "./chunk-CmEholJ9.js";
//#region node_modules/simplelightbox/dist/simple-lightbox.min.js
(function n(i, s, a) {
	function r(e, t) {
		if (!s[e]) {
			if (!i[e]) {
				...
				if (!t && o) return o(e, !0);
				if (l) return l(e, !0);
				throw (t = /* @__PURE__ */ new Error("Cannot find module '" + e + "'")).code = "MODULE_NOT_FOUND", t;
			}
			o = s[e] = { exports: {} }, i[e][0].call(o.exports, function(t) {
				return r(i[e][1][t] || t);
			}, o, o.exports, n, i, s, a);
		}
		return s[e].exports;
	}
	for (var l = "function" == typeof __require && __require, t = 0; t < a.length; t++) r(a[t]);
	return r;
})({ 1: [function(t, e, o) {
	(function(e) {
		(function() {
			...
			var t = function() {
									...
									try {
										for (l.s(); !(a = l.n()).done;) {
											...
											0 <= [
												...
												"mousewheel",
												"DOMMouseScroll"
											].indexOf(d.split(".")[0]) && this.isPassiveEventsSupported && ("object" === h(c) ? c.passive = !0 : c = { passive: !0 }), r.namespaces[d] = o, r.addEventListener(d.split(".")[0], o, c);
										}
									} catch (t) {
										l.e(t);
									} finally {
				...
				]) && s(t.prototype, e), o && s(t, o), Object.defineProperty(t, "prototype", { writable: !1 }), i;
			}();
...
//# sourceMappingURL=simplelightbox_dist_simple-lightbox__min__js.js.map