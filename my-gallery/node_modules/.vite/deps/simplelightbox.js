import { t as __commonJSMin } from "./chunk-CmEholJ9.js";
//#region node_modules/simplelightbox/dist/simple-lightbox.modules.js
/*!
...
Version 2.14.3
*/
var require_simple_lightbox_modules = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	var SimpleLightbox = /*#__PURE__*/ function() {
		function SimpleLightbox(elements, options) {
			...
			if (this.options.docClose) this.addEventListener(this.domNodes.wrapper, ["click." + this.eventNamespace, "touchstart." + this.eventNamespace], function(event) {
			...
			if (this.options.enableKeyboard) this.addEventListener(document.body, "keyup." + this.eventNamespace, this.throttle(function(event) {
				...
				if (_this.isOpen) {
					...
					if (!_this.isAnimating && ["ArrowLeft", "ArrowRight"].indexOf(event.key) > -1) _this.loadImage(event.key === "ArrowRight" ? 1 : -1);
				}
		...
		_createClass(SimpleLightbox, [
			...
			},
			{
				...
				value: function adjustImage(direction) {
					...
					tmpImage.addEventListener("load", function(event) {
						...
						if (_this5.options.captions && captionContainer) if (_this5.options.captionType === "data") captionText = captionContainer.dataset[_this5.options.captionsData];
					...
					this.addEventListener(this.domNodes.image, [
						...
						if (_this6.isTouchDevice && event.type === "touchend") {
							...
							if (_this6.controlCoordinates.touchCount === 0) {
								if (_this6.currentImage) _this6.setZoomData(_this6.controlCoordinates.initialScale, _this6.controlCoordinates.targetOffsetX, _this6.controlCoordinates.targetOffsetY);
								if (_this6.controlCoordinates.initialScale === 1) {
									_this6.controlCoordinates.zoomed = false;
									if (_this6.domNodes.caption.style.display === "none") _this6.fadeIn(_this6.domNodes.caption, _this6.options.fadeSpeed);
								}
						...
						if (_this6.controlCoordinates.mousedown) {
							...
							else if (_this6.options.animationSlide) _this6.slide(_this6.options.animationSpeed / 1e3, "0px");
							...
							try {
								for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
									...
									if ([
										...
										"mousewheel",
										"DOMMouseScroll"
									].indexOf(event.split(".")[0]) >= 0 && this.isPassiveEventsSupported) if (_typeof(options) === "object") options.passive = true;
			...
			},
			{
				...
				value: function fadeIn(elements, duration, callback, display) {
					...
					this.isFadeIn = true;
					var opacityTarget = parseFloat(elements[0].dataset.opacityTarget || 1), step = 16.66666 * opacityTarget / (duration || this.options.fadeSpeed);
					(function fade() {
						var currentOpacity = parseFloat(elements[0].style.opacity);
