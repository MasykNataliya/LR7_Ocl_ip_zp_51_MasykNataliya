import { n as __require, t as __commonJSMin } from "./chunk-CmEholJ9.js";
//#region node_modules/basiclightbox/dist/basicLightbox.min.js
var require_basicLightbox_min = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e) {
		...
		return function e(n, t, o) {
			function r(c, u) {
				if (!t[c]) {
					if (!n[c]) {
						...
						if (!u && s) return s(c, !0);
						if (i) return i(c, !0);
						var a = /* @__PURE__ */ new Error("Cannot find module '" + c + "'");
			...
			t.create = function(e, n) {
				var t = function(e, n) {
					...
					if ((e = Object.assign({}, e)).closable ?? (e.closable = !0), e.className ?? (e.className = ""), e.onShow ?? (e.onShow = function() {}), e.onClose ?? (e.onClose = function() {}), "boolean" != typeof e.closable) throw new Error("Property `closable` must be a boolean");
